...
es = Elasticsearch()
print("HELLO")
cat_dct = {"e":"Sports and Entertainment","b":"Business and Finance","m":"Health","t":"Science and Technology"}
...
#list_keys["ta1"].insert(END,"HELLLO THIS THIS WORKING" )
    ...
    if len(res_hits) == 0:
    #print("No results")
        list_keys["ta1"].insert(END,"NO RESULTS" )
        count = count + 1
        list_keys["ta2"].insert(END,"NO RESULTS" )
        count = count + 1
        list_keys["ta3"].insert(END,"NO RESULTS" )
    ...
    #ta3.insert(END,elem["_source"]["category"])
        ...
        count = count + 1
        list_keys["ta{}".format(count)].insert(END,cat_dct[elem["_source"]["category"]])
        count = count + 1
...
l1=Label(window,text="Keywords",height=2,width=8,font=("Calibri", 25))
...
l2=Label(window,text="Category",height=3,width=8,font=("Calibri", 25))
...
Headline_Label=Label(window,text="Headline",height=5,width=8,font=("Calibri", 20))
Headline_Label.grid(row=4,column=0)
Url_Label=Label(window,text="URL",height=5,width=8,font=("Calibri", 20))
Url_Label.grid(row=4,column=1)
Category_Label=Label(window,text="Category",height=5,width=8,font=("Calibri", 20))
Category_Label.grid(row=4,column=2)

Business_Label=Label(window,text="b -> Business and Finance",height=1,width=30,font=("Calibri", 15))
Business_Label.grid(row=2,column=0)
Entertainment_Label=Label(window,text="e -> Entertainment and Sports",height=1,width=30,font=("Calibri", 15))
Entertainment_Label.grid(row=2,column=1)
Medical_Label=Label(window,text="m -> Medical",height=3,width=30,font=("Calibri", 15))
Medical_Label.grid(row=3,column=0)
Tech_Label=Label(window,text="t -> Technology",height=3,width=30,font=("Calibri", 15))
Tech_Label.grid(row=3,column=1)

row_no = 5
list_keys = {}
for x in range(1,16,3):
        for y in range(0,3):
            list_keys.update({"ta{}".format(x) : Text(window,height=5,width=30, font=("Calibri", 15))})
